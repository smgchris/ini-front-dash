  ...
  render() {
    ...
    if (searchTerm !== "") {
      trxItems = sortedItems.map((trx, index) => {
        if (
          trx.type === 0 &&
          (trx.reason.toLowerCase().includes(searchTerm) ||
            trx.initiator.firstName.toLowerCase().includes(searchTerm) ||
            (trx.recipient !== null &&
      ...
      if (filterStatus !== "") {
        var temp = sortedItems;
        trxItems = temp.map((trx, index) => {
          if (
            trx.type === 0 &&
          ...
          <div class="col-sm-12 col-md-6 mb-3">
            <div id="example_filter" class="dataTables_filter">
              ...
              <Input
                ...
                placeholder="sender's name or receiver's phone or reason"
